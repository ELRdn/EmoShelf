...
> **2026-09-26更新**：正式版も未署名で提供し、更新は手動とする。SignPath承認を公開条件にしない。最新の変更・実操作・配布候補・未確認事項は[公開前レビュー](app/docs/launch-review-20260926.md)と[配布手順](app/docs/release.md)を正本とする。下記の署名前提の記録は過去の計画。
...
3. 同一コミットのCI成果物を未署名workflowで検証し、チェックサム付きの未公開ドラフトを作る
